...
.
      ...
      *     END-IF.
           ...
           THEN
             MOVE 'ENE05'              TO AIF-MSG-CODE
             STRING '�ѿ�I������:', O-ACC-LEGAL-OPEN OF PCECACNC 
           ...
           THEN
             MOVE 'ENE06'              TO AIF-MSG-CODE
             STRING '�ѿ�II������:', O-ACC-LEGAL-OPEN OF PCECACNC 
               DELIMITED BY SIZE INTO  AIF-MSG-TEXT
             PERFORM 9999-MESSAGE-HANDLE-RTN
           END-IF
      * ȫʡ�ڿ������ޱ�־     
      ...
      * ��������:1���۽��� 2�������� 3����+�۽���
           ...
           THEN
             ...
             THEN
               ...
               STRING '�ѿ���������:', O-ACC-LEGAL-OPEN OF PCECACND 
                  DELIMITED BY SIZE INTO  AIF-MSG-TEXT
               PERFORM 9999-MESSAGE-HANDLE-RTN
             END-IF
           END-IF.
      ...
      * ��������:1���۽��� 2�������� 3����+�۽���
           ...
           THEN
             ...
             THEN
               ...
               STRING '�����۽�������:', O-ACC-LEGAL-OPEN OF PCECACND 
                 DELIMITED BY SIZE INTO  AIF-MSG-TEXT
               PERFORM 9999-MESSAGE-HANDLE-RTN
             END-IF
           END-IF.
