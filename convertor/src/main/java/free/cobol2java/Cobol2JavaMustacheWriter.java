        ...
        this.getExprEvaluator().setEnvironment(new MustacheEnvironment() {
            ...
            public void addDefault() {
                ...
                if (exprContext == null) {
                    ...
                    getGlobalVariables().add(LOCAL_CONTEXT);
                }
                exprContext.setEnvironment(this);
                addFunction("debug", args -> ((ExprContext) getVar(LOCAL_CONTEXT)).debugPoint());
...
//                addFunction("expr_convertFuncParam", args -> ((ExprContext) getVar(LOCAL_CONTEXT)).expr_convertFuncParam((ParserRuleContext) args[0]));
                ...
                addFunction("type_replace", args -> ((ExprContext) getVar(LOCAL_CONTEXT)).type_replace((String) args[0],(String) args[1]));
