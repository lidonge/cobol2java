    ...
    DATA DIVISION.
       ...
       01 WS-TABLE.
          05 WS-SRCH PIC A(10) VALUE 'TUTORIALS'.
          05 WS-SRCH1 PIC A(10) VALUE 'TUTORIALS'.
          05 WS-A PIC A(10) VALUE 'TUTORIALS' OCCURS 5 TIMES INDEXED BY I J.
          05 TSYSSBCA-ITEM OCCURS 1 TO 9999 TIMES
              DEPENDING ON WS-SRCH
              ASCENDING KEY IS WS-SRCH1.
             10 WS-B11 PIC A(10).
       01 WS-TABLE1.
